          ...
          {facultyDetails.map((faculty, index) => (
            ...
            >
              <div className="relative w-full backface-hidden group-hover:-rotate-y-180 transform-3d transition-transform duration-600 origin-center h-full rotate-y-0 ease-in-out ">
                ...
                />
                <h2 className="text-lg font-bold relative text-white text-shadow bg-blue-950">
                  {faculty.name}
                </h2>
              </div>
              <motion.div className="absolute bg-white shadow-2xl border inset-0 flex flex-col items-center justify-center p-4 backface-hidden rotate-y-180 group-hover:-rotate-y-0 transform-3d transition-transform duration-600 origin-center">
