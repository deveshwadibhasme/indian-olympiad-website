...
const ContactPage = () => {
  ...
  return (
    <div className="w-full flex-center flex-col relative mx-auto bg-slate-50">
      <div className="max-w-full rounded-xl bg-white w-full min-h-[550px] shadow-sm shadow-slate-500 mx-auto px-6 py-9 flex items-center flex-col">
        <h1 className="text-2xl md:mt-10 relative hori-strip after:top-15 md:text-4xl text-blue-600 text-center font-bold">
          Contact Us
        </h1>
        <div
          onClick={() => setdirChange(!dirChange)}
          className={`w-96 min-h-14 mt-5 flex relative bg-slate-200 rounded-xl ${
