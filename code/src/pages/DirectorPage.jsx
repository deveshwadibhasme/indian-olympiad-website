  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div
          variants={variants}
          className="relative flex flex-col justify-center gap-1 items-center z-20"
        >
          <motion.h1
            className="text-2xl md:text-4xl font-bold text-shade-blue-light t mb-8 relative"
          >
            Directors
          ...
          <div className="flex flex-col md:flex-row gap-20 items-center">
              <img
                ...
                alt="Director Mr. Suhail Ahmed Khan"
                className="w-auto h-[300px] object-cover transform hover:scale-105 transition-transform duration-300"
                style={{
                  filter: "contrast(1.2) brightness(1.1)",
                }}
              />
              <h1 className="text-2xl md:text-3xl text-black t mb-8 relative">Umair Khan</h1>
              <h1 className="text-2xl md:text-3xl text-black t mb-8 relative">Uzair Khan</h1>
                <img
                loading="lazy"
                src={getImageLink(
