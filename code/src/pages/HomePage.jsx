  ...
  return (
    <>
      <section className="w-full mx-auto bg-white relative shaded-bg">
        ...
        <motion.div
          className="absolute top-1/4 text-white -translate-y-1/2 text-2xl md:text-5xl text-shadow-[0px_4px_10px] text-shadow-black font-semibold left-2 md:left-15 w-70 md:w-110 z-10"
